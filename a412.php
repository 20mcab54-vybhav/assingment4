...
<body>
	<div class="w3-container w3-full w3-small w3-margin-top">
		<form class="w3-container w3-card-4" method="POST">
			<center><h2><b><i><font color=yellow >Select Your Item</font></i></b></h2></center>
  ...
  <br>
  <br>
  <input class="w3-button w3-yellow w3-center" type="submit" name="form_submit">
  <br>
 <br>
		</form>
	</div>
	...
	<div class="w3-container w3-half w3-small w3-margin-top w3-container w3-card-2">
		...
		<br>
		<input class="w3-button w3-yellow w3-right" type="submit" name="qty_sub">
		<br><br>
		</form>
	</div>
